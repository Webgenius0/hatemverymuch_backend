...
<head>
    ...
    <title><?php echo e(config('app.name', 'Admin')); ?> | Admin Dashboard </title>
    ...
    <div id="page" class="">
        ...
        <div class="layout-wrap">
            ...
            <div class="section-menu-left">
                <div class="box-logo">
                    <a href="<?php echo e(asset('admin.dashboard')); ?>" id="site-logo-inner">
                        <img class="" id="logo_header" alt="" src="<?php echo e(asset('images/logo/logo.png')); ?>" data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" >
                    </a>
                        ...
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'menu-item-button active' : ''); ?>">
                                ...
                                <li class="menu-item <?php echo e(request()->routeIs('users.index') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('users.index')); ?>" class="<?php echo e(request()->routeIs('users.index') ? 'menu-item-button active' : ''); ?>">
                ...
                <div class="header-dashboard">
                    <div class="wrap">
                        <div class="header-left">
                            <a href="<?php echo e(asset('index.html')); ?>">
                                <img class="" id="logo_header_mobile" alt="" src="<?php echo e(asset('images/logo/logo.png')); ?>" data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" data-width="154px" data-height="52px" data-retina="images/logo/logo@2x.png">
                            </a>
                            <div class="button-show-hide">
                                <i class="icon-menu-left"></i>
                            </div>
                                            ...
                                            <ul>
                                                <li class="product-item gap14 mb-10">
                                                    ...
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        <div class="name">
                                                            <a href="<?php echo e(asset('product-list.html')); ?>" class="body-text">Dog Food Rachael Ray Nutrish®</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="mb-10">
                                                ...
                                                <li class="product-item gap14 mb-10">
                                                    ...
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        <div class="name">
                                                            <a href="<?php echo e(asset('product-list.html')); ?>" class="body-text">Natural Dog Food Healthy Dog Food</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="mb-10">
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        <div class="name">
                                                            <a href="<?php echo e(asset('product-list.html')); ?>" class="body-text">Freshpet Healthy Dog Food and Cat</a>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                    ...
                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    ...
                                                    <span class="text-tiny"><?php echo e(Auth::user()->role); ?></span>
                                                </span>
                                            </span>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3" >
                                        <li>
                                            <a href="<?php echo e(asset('#')); ?>" class="user-item">
                                                <div class="icon">
                                                    <i class="icon-user"></i>
                                                </div>
                                        ...
                                        <li>
                                            <a href="<?php echo e(asset('setting.html')); ?>" class="user-item">
                                                <div class="icon">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('logout')); ?>" class="user-item" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                                <div class="icon">
                                                    <i class="icon-log-out"></i>
                                                </div>
                                                <div class="body-title-2"><?php echo e(__('Logout')); ?></div>
                                            </a>
...
<script src="<?php echo e(asset('js/jvectormap-1.2.2.min.js')); ?>"></script>
...
<?php /**PATH C:\Users\Ridoan\SoftVence-Projects\wp_monkey\smutly-hatemverymuch_backend\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>