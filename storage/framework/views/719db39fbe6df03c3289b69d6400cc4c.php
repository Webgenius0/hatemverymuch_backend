                        ...
                        <div class="wg-chart-default">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Total Fans</div>
                                        <h4>34,945</h4>
                                    </div>
                                </div>
                        ...
                        <div class="wg-chart-default">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Total Creators</div>
                                        <h4>$37,802</h4>
                                    </div>
                                </div>
                        ...
                        <div class="wg-chart-default">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Total Transaction</div>
                                        <h4>34,945</h4>
                                    </div>
                                </div>
                        ...
                        <div class="wg-box">
                            ...
                            <div class="wg-table table-top-selling-product">
                                <ul class="table-title flex gap20 mb-14">
                                    ...
                                    <li>
                                        <div class="body-title">Dates</div>
                                    </li>
                                </ul>
                        ...
                        <div class="wg-box">
                            ...
                            <div class="wg-table table-orders-1">
                                <ul class="table-title flex gap10 mb-14">
                                    ...
                                    <li>
                                        <div class="body-title">Withdraw date</div>
                                    </li>
                                </ul>
                                <div class="divider mb-14"></div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ridoan\SoftVence-Projects\wp_monkey\smutly-hatemverymuch_backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>